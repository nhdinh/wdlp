-- Forward-only persistence for authenticated post-enrollment routes.
-- No credentials, signed configuration payloads, or seed data are embedded.
...
CREATE UNIQUE INDEX device_route_credentials_one_active_per_device
    ON device_route_credentials (device_id)
