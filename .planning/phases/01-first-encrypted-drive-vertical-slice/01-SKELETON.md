...
| Encrypted storage | AES-256-GCM, 4 MiB chunks, random persisted 96-bit nonce per record, identity-bound AAD, staged generations, authenticated commit record | Satisfies D-12 through D-15 and makes restart recovery deterministic. |
